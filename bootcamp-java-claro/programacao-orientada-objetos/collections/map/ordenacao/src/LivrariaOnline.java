...
public class LivrariaOnline {
    ...
    public Map<String, Livro> exibirLivrosOrdenadosPorPreco() {
        ...
        Map<String, Livro> livrosOrdenadosPorPrecos = new LinkedHashMap<>();

        for(Map.Entry<String, Livro> entry : livrosParaOrdenarPorPreco) {
            livrosOrdenadosPorPrecos.put(entry.getKey(), entry.getValue());
        }

        return livrosOrdenadosPorPrecos;
    }
    ...
    public List<Livro> obterLivroMaisBarato() {
        ...
        for(Map.Entry<String, Livro> entry : livros.entrySet()) {
            if(entry.getValue().getPreco() == precoMaisBaixo) {
                Livro livroComPrecoBaixo = livros.get(entry.getKey());
                livrosMaisBaratos.add(livroComPrecoBaixo);
            }
        }
